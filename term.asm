...
LD HL,41F8H ; POKE 16888, 2*17
LD A, 2*17  ; TX/RX BAUDRATE 0=50, 2=110, 5=300, 12=4800, 14=9600, 15=19200
LD (HL),A

CALL 0050H  ; CALL $RSRCV [80]
CALL 0055H  ; CALL $RSTX [85]
CALL 005AH  ; CALL $RSINIT [90]
